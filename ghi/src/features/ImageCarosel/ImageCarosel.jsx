	...
	return (
		<>
			<div className="carosel-container">
				...
				<section id="slider">
					<input type="radio" name="slider" id="s1" hidden defaultChecked />
					<input type="radio" name="slider" id="s2" hidden defaultChecked />
					<input type="radio" name="slider" id="s3" hidden defaultChecked />
					<input type="radio" name="slider" id="s4" hidden defaultChecked />
					<input type="radio" name="slider" id="s5" hidden defaultChecked />
